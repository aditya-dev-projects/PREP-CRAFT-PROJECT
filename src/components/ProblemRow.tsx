...
export const ProblemRow = ({ problem, onToggle }: ProblemRowProps) => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 rounded-lg border transition-all ${
      ...
      <div className="flex items-center gap-2 ml-0 sm:ml-4 mt-2 sm:mt-0 self-end sm:self-center">
        {problem.articleLink && (
          <Button
            variant="ghost"
            size="sm"
