// src/components/PrepareSidebar.tsx
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-border flex justify-between items-center">
            <h2 className="text-lg font-bold text-primary">{prepareCourse.title}</h2>
            <button
          ...
          <div className="flex-1 overflow-y-auto">
            <nav className="p-4">
              {prepareCourse.chapters.map((chapter) => (
                  ...
                  >
                    {chapter.subChapters.map((subChapter) => (
                      <li key={subChapter.id} className="mb-1">
                        <Link
                          to={`/prepare/${chapter.folder}/${subChapter.file}`}
...
export default React.memo(PrepareSidebar);
